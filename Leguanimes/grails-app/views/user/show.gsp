	...
	<div id="show-user" class="content scaffold-show" role="main">
		...
		<ol class="property-list user">
			...
			<g:if test="${userInstance?.username}">
				<li class="fieldcontain"><span id="username"
			...
			<g:if test="${userInstance?.birthday}">
				<li class="fieldcontain"><span id="birthday-label"
					class="property-label"><g:message code="user.birthday.label"
							default="Birthday" /></span> <span class="property-value"
					aria-labelledby="birthday-label"><g:formatDate
							date="${userInstance?.birthday}" /></span></li>
			</g:if>

			<g:if test="${userInstance?.avatar}">
				<li class="fieldcontain"><span id="avatar-label"
					class="property-label"><g:message code="user.avatar.label"
							default="Avatar" /></span> <span class="property-value"
					aria-labelledby="avatar-label"><g:fieldValue
							bean="${userInstance}" field="avatar" /></span></li>
			</g:if>

			<g:if test="${userInstance?.blockedAccount}">
				<li class="fieldcontain"><span id="blockedAccount-label"
					class="property-label"><g:message
							code="user.blockedAccount.label" default="Blocked Account" /></span> <span
					class="property-value" aria-labelledby="blockedAccount-label"><g:formatBoolean
							boolean="${userInstance?.blockedAccount}" /></span></li>
			</g:if>

			<g:if test="${userInstance?.expiredAccount}">
				<li class="fieldcontain"><span id="expiredAccount-label"
					class="property-label"><g:message
							code="user.expiredAccount.label" default="Expired Account" /></span> <span
					class="property-value" aria-labelledby="expiredAccount-label"><g:formatBoolean
							boolean="${userInstance?.expiredAccount}" /></span></li>
			</g:if>

			<g:if test="${userInstance?.expiredPassword}">
				<li class="fieldcontain"><span id="expiredPassword-label"
					class="property-label"><g:message
							code="user.expiredPassword.label" default="Expired Password" /></span>

					<span class="property-value"
					aria-labelledby="expiredPassword-label"><g:formatBoolean
							boolean="${userInstance?.expiredPassword}" /></span></li>
			</g:if>
			...
			<g:if test="${userInstance?.role}">
				<li class="fieldcontain"><span id="role-label"
					...
					aria-labelledby="role-label"><g:link controller="role"
							action="show" id="${userInstance?.role?.id}">
							${userInstance?.role?.encodeAsHTML()}
						</g:link></span></li>
			</g:if>
