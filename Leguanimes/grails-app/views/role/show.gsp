	...
	<body>
		...
		<div id="show-role" class="content scaffold-show" role="main">
			...
			<ol class="property-list role">
				...
				<g:if test="${roleInstance?.type}">
				<li class="fieldcontain">
					<span id="type-label" class="property-label"><g:message code="role.type.label" default="Type" /></span>
					
						<span class="property-value" aria-labelledby="type-label"><g:fieldValue bean="${roleInstance}" field="type"/></span>
