		...
		<div id="show-anime" class="content scaffold-show" role="main">
			...
			<ol class="property-list anime">
				...
				<li class="fieldcontain">
					<span id="startDate-label" class="property-label"><g:message code="anime.startDate.label" default="Start Date" /></span>
					
						<span class="property-value" aria-labelledby="startDate-label"><g:formatDate date="${animeInstance?.startDate}" /></span>
				...
				<li class="fieldcontain">
					<span id="endDate-label" class="property-label"><g:message code="anime.endDate.label" default="End Date" /></span>
					
						<span class="property-value" aria-labelledby="endDate-label"><g:formatDate date="${animeInstance?.endDate}" /></span>
				...
				<li class="fieldcontain">
					<span id="exibition-label" class="property-label"><g:message code="anime.exibition.label" default="Exibition" /></span>
						...
						<span class="property-value" aria-labelledby="exibition-label"><g:link controller="exibition" action="show" id="${animeInstance?.exibition?.id}">${animeInstance?.exibition?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="endings-label" class="property-label"><g:message code="anime.endings.label" default="Endings" /></span>
					
						<g:each in="${animeInstance.endings}" var="e">
						<span class="property-value" aria-labelledby="endings-label"><g:link controller="ending" action="show" id="${e.id}">${e?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="episodes-label" class="property-label"><g:message code="anime.episodes.label" default="Episodes" /></span>
				...
				<li class="fieldcontain">
					<span id="fansubs-label" class="property-label"><g:message code="anime.fansubs.label" default="Fansubs" /></span>
					
						<g:each in="${animeInstance.fansubs}" var="f">
						<span class="property-value" aria-labelledby="fansubs-label"><g:link controller="fansub" action="show" id="${f.id}">${f?.encodeAsHTML()}</g:link></span>
						</g:each>
