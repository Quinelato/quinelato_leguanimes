...
<body>
	<a href="#list-producer" class="skip" tabindex="-1"><g:message
			...
			<thead>
				<tr>
					...
					<g:sortableColumn property="name"
						title="${message(code: 'producer.name.label', default: 'Name')}" />
						
					<g:sortableColumn property="createdAt"
						title="${message(code: 'producer.createdAt.label', default: 'Created At')}" />

					<g:sortableColumn property="removedAt"
						title="${message(code: 'producer.removedAt.label', default: 'Removed At')}" />

					<th><g:message code="producer.createdBy.label"
							default="Created By" /></th>

					<g:sortableColumn property="active"
						title="${message(code: 'producer.active.label', default: 'Active')}" />

				</tr>
			</thead>
			<tbody>
				<g:each in="${producerInstanceList}" status="i"
					var="producerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">

						<td><g:link action="show" id="${producerInstance.id}">
								${fieldValue(bean: producerInstance, field: "name")}
							</g:link></td>
						...
						<td>
							${fieldValue(bean: producerInstance, field: "createdBy")}
						</td>
