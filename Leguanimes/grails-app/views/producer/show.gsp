...
<body>
	<a href="#show-producer" class="skip" tabindex="-1"><g:message
		...
		<ol class="property-list producer">
			...
			<g:if test="${producerInstance?.active}">
				<li class="fieldcontain"><span id="active-label"
					class="property-label"><g:message
							code="producer.active.label" default="Active" /></span> <span
					class="property-value" aria-labelledby="active-label"><g:formatBoolean
							boolean="${producerInstance?.active}" /></span></li>
			</g:if>

		</ol>
		<g:form url="[resource:producerInstance, action:'delete']"
			method="DELETE">
			<fieldset class="buttons">
				<g:link class="edit" action="edit" resource="${producerInstance}">
