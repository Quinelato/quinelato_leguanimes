...
<g:set var="entityName"
	value="${message(code: 'fansub.label', default: 'Fansub')}" />
<title><g:message code="default.show.label" args="[entityName]" /></title>
</head>
<body>
	<a href="#show-fansub" class="skip" tabindex="-1"><g:message
		...
		<ol class="property-list fansub">
			...
			<g:if test="${fansubInstance?.active}">
				<li class="fieldcontain"><span id="active-label"
					class="property-label"><g:message code="fansub.active.label"
							default="Active" /></span> <span class="property-value"
					aria-labelledby="active-label"><g:formatBoolean
							boolean="${fansubInstance?.active}" /></span></li>
			</g:if>

		</ol>
		<g:form url="[resource:fansubInstance, action:'delete']"
			method="DELETE">
			<fieldset class="buttons">
				<g:link class="edit" action="edit" resource="${fansubInstance}">
